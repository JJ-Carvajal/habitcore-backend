...
async function cargarDashboardAdmin() {
    try {
        ...
        const res = await fetch('https://habitcore-backend.onrender.com/api/admin/estadisticas', {
...
async function cargarUsuarios() {
    try {
        ...
        const url = 'https://habitcore-backend.onrender.com/api/admin/usuarios' + (qs ? '?' + qs : '');
...
async function guardarUsuario(e) {
    ...
    const token = localStorage.getItem('token');
    const url = id ? `https://habitcore-backend.onrender.com/api/admin/usuarios/${id}` : 'https://habitcore-backend.onrender.com/api/admin/usuarios';
...
async function editarUsuario(id) {
    try {
        const token = localStorage.getItem('token');
        const res = await fetch(`https://habitcore-backend.onrender.com/api/admin/usuarios/${id}`, {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function cargarCategorias() {
    try {
        ...
        const res = await fetch('https://habitcore-backend.onrender.com/api/admin/categorias' + params, {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function guardarCategoria(e) {
    ...
    const token = localStorage.getItem('token');
    const url = id ? `https://habitcore-backend.onrender.com/api/admin/categorias/${id}` : 'https://habitcore-backend.onrender.com/api/admin/categorias';
    const method = id ? 'PUT' : 'POST';
    try {
        const res = await fetch(url, {
            method,
...
async function editarCategoria(id) {
    try {
        const token = localStorage.getItem('token');
        const res = await fetch(`https://habitcore-backend.onrender.com/api/admin/categorias/${id}`, {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function cargarHabitosAdmin() {
    try {
        ...
        const [resHab, resUsu, resCat] = await Promise.all([
            fetch('https://habitcore-backend.onrender.com/api/admin/habitos' + (qs ? '?' + qs : ''), { headers }),
            fetch('https://habitcore-backend.onrender.com/api/admin/usuarios', { headers }),
            fetch('https://habitcore-backend.onrender.com/api/admin/categorias', { headers })
        ]);
...
async function cargarRegistrosAdmin() {
    try {
        ...
        const [resReg, resUsu, resCat, resHab] = await Promise.all([
            fetch('https://habitcore-backend.onrender.com/api/admin/registros' + (qs ? '?' + qs : ''), { headers }),
            fetch('https://habitcore-backend.onrender.com/api/admin/usuarios', { headers }),
            fetch('https://habitcore-backend.onrender.com/api/admin/categorias', { headers }),
            fetch('https://habitcore-backend.onrender.com/api/admin/habitos', { headers })
        ]);
